export const DEMO_TITLES: {[key: string]: string} = {
  ...
  fast_neural_style: 'Fast Neural Style Transfer, image style transfer'
};
...
export const DEMO_DESCRIPTIONS: {[key: string]: string} = {
  ...
  mnist: 'MNIST, handwritten digit prediction.',
  fast_neural_style: 'Fast Neural Style Transfer, mixes the content of an image with the style of another image.'
};
...
export const DEMO_MODEL_LINKS: {[key: string]: string} = {
  ...
  fast_neural_style: 'https://github.com/onnx/models/tree/master/vision/style_transfer/fast_neural_style'
};