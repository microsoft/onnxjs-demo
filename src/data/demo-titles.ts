...
export const DEMO_DESCRIPTIONS: {[key: string]: string} = {
  ...
  emotion: 'FER+ Emotion, a deep convolutional neural network for emotion recognition in faces.',
  mnist: 'MNIST, handwritten digit prediction.'
};
...
export const DEMO_MODEL_LINKS: {[key: string]: string} = {
  ...
  emotion: 'https://github.com/onnx/models/tree/master/emotion_ferplus',
